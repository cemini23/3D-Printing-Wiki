---
title: gracia.ai — Gaussian Splatting volumetric video (3D-export angle)
type: concept
tags: [AI, generative-3D, gaussian-splatting, volumetric, mesh-export, scanning]
...
- @concepts/ai-design-tools.md — sibling generative-3D-to-printable-mesh pipeline; gracia is the volumetric-capture variant
...
`[NEEDS VERIFICATION 2026-05-15]` whether gracia.ai exposes any mesh/`.stl`/`.obj` export path, and its license.

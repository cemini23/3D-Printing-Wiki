...
- [Manufacturing Complex Airtight Soft Pneumatic Actuators (arXiv:2608.13233)](sources/2026-abboodi-airtight-spa-fdm.md) — 5-route process eval; FDM TPU retained; 3×0.32 mm walls seal > 2×0.8 mm; Phase-0 REFERENCE — `paper, soft-robotics, pneumatic, TPU, FDM`
- [Unified geometric design framework for kirigami (arXiv:2608.30032)](sources/2026-jiang-unified-kirigami-design.md) — multi-state inverse kirigami IPM; inertia transposition + angle-defect limits; TPU demo; Phase-0 REFERENCE — `paper, kirigami, metamaterials, shape-morphing`
...
- [PyKirigami](entities/tools/pykirigami.md) — kirigami deployment simulator (Apache-2.0); Phase-0 REFERENCE — `tool, kirigami, simulation, Python, phase-0`
...
- [Shape-Changing Interfaces — FDM and Adjacent Modalities](concepts/shape-changing-fdm-interfaces.md) — hub: PvP SMP 4D, DuoMorph pneumatics, kirigami design REFERENCE, FluxLab SLA contrast, LCE background — `shape-changing, 4D, pneumatic, SMP, maker`
